    ...
    <div class="x_content">
      ...
      <div class="item form-group">
        ...
        <div class="item form-group">
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
                <?php echo $this->Form->input("contract_value_bdt", array("type" => "number", 'label' => false, 'div' => false, 'class' => "form-control col-md-7 col-xs-12 numeric_number",'step'=>'any','id'=>'contract_value_bdt')) ?>
             </div>
         </div>
         <div class="item form-group">
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
               <?php echo $this->Form->input("contract_value_usd", array("type" => "number", 'label' => false, 'div' => false, 'class' => "form-control col-md-7 col-xs-12 numeric_number",'step'=>'any','id'=>'contract_value_usd')) ?>
             </div>
         </div>
        <div class="item form-group">
